...
public class AlteracaoAluno extends JFrame implements  ActionListener, ListSelectionListener, ItemListener
{
   JButton B1, B2;
   JTextField Nome, CPF, Ra, Est, Email, Tel;
   ...
   private void btnAlterarActionPerformed() {
	    try {
	        ...
	        objinseredao.AlterarDados(objarmazenadto); 

...
public class ExclusaoProfessor extends JFrame implements ActionListener, ListSelectionListener, ItemListener{
   JButton B1, B2, B3;
   ...
   {
      setTitle("Tela de Exlusão dos Dados do Professor");
      setSize(550,550);
      setLocation(80,50);
      setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
      L1 = new JLabel("EXCLUSÃO DOS DADOS DO PROFESSOR");
   ...
   {
      new ExclusaoProfessor().setVisible(true);
   }
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      private void btnExcluirActionPerformed() {
  	    try {
  	        ...
  	        objinseredao.ExcluirDados3(objarmazenadto); 

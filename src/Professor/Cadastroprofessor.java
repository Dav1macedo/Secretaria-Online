...
public class Cadastroprofessor extends JFrame implements ActionListener, ListSelectionListener, ItemListener  
{
   JButton B1, B2 ;
   ...
   {
      setTitle("Tela de Cadastro dos Dados do Professor");
      setSize(550,550);
      setLocation(80,50);
      setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
      L1 = new JLabel("CADASTRO DOS DADOS DO PROFESSOR");
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      private void btnCadastrarActionPerformed() {
    	    try {
    	        ...
    	        objinseredao.InserirDados3(objarmazenadto); 

...
public class ConsultaProfessor extends JFrame implements ActionListener, ListSelectionListener, ItemListener
{
   JButton B1, B2;
   ...
   {
      setTitle("Tela de Consulta dos Dados do Professor");
      setSize(550,550);
      setLocation(80,50);
      setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
      L1 = new JLabel("CONSULTA DOS DADOS DO PROFESSOR");
   ...
   private void btnConsultarActionPerformed() {
	    try {
	        ...
	        ArmazenaDTO ConsultaEncontrada = objinseredao.ConsultaDados3(objarmazenadto);

	        if (ConsultaEncontrada != null) {
	            // Exibir os dados do aluno encontrado                     
	            String mensagem = "Professor encontrado:\n" +
	                              "Código do Prof.: " + ConsultaEncontrada.getCodProf() + "\n" +
	                              "Nome do Prof.: " + ConsultaEncontrada.getNomeProf() + "\n" +
	                              "Cpf do Prof.: " + ConsultaEncontrada.getCpfProf() + "\n" +
	                              "Cidade: " + ConsultaEncontrada.getCid()+ "\n" +
	    	                      "Telefone: " + ConsultaEncontrada.getTelProf() + "\n" +
	    	                      "Email: " + ConsultaEncontrada.getEmailProf() + "\n" +
	    	                      "Disciplina do Prof.: " + ConsultaEncontrada.getDiscProf()  + "\n" +
	    	                      "Curso do Prof.: " + ConsultaEncontrada.getCurProf();

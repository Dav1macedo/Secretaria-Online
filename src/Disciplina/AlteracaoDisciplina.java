...
public class AlteracaoDisciplina extends JFrame implements ActionListener 
{
   JButton B1, B2;
   ...
   public AlteracaoDisciplina()
   {
      ...
      L1 = new JLabel("ALTERAÇÃO DOS DADOS DO DISCIPLINA");
      ...
      if (e.getSource() == B2)
       ...
       private void btnAlterarActionPerformed() {
    	    try {
    	        ...
    	        objinseredao.AlterarDados2(objarmazenadto); 
